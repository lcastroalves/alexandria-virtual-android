...
class TelaEventosFuturUsu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val eventos = mutableListOf(
            Evento(R.drawable.totoro, "16/09/2025", "16/09/2025", "16 - 17:30", "O filme de animação será reproduzido no auditório das 16 - 17:30", "O filme de animação será reproduzido no auditório das 16 - 17:30",true, "Auditório Principal"),
